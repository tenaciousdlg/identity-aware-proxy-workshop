...
const SERVICE_NAME = process.env.SERVICE_NAME || 'alice-app';
...
app.get('/', (req, res) => {
  ...
  const response = {
    service: SERVICE_NAME,
    message: `Welcome to Alice's personal service!`,
    description: 'This service is only accessible by Alice. Envoy enforces that only users named "alice" can access this endpoint.',
    warning: '🔒 This is Alice\'s private workspace',
  ...
  response.security_note = 'If you can see this, Envoy has validated that you are Alice.';
